...
NloglikFD1 <- function(par, outdata_F, outdata_proband, Age, Cal, lam03, fgau, fdpexp, fppexp, combn) {
    .Call(`_clusteridm_NloglikFD1`, par, outdata_F, outdata_proband, Age, Cal, lam03, fgau, fdpexp, fppexp, combn)
}
