...
// NloglikFD1
double NloglikFD1(NumericVector par, List outdata_F, NumericVector outdata_proband, Function fgau, Function fdpexp, Function fppexp, Function combn);
RcppExport SEXP _clusteridm_NloglikFD1(SEXP parSEXP, SEXP outdata_FSEXP, SEXP outdata_probandSEXP, SEXP fgauSEXP, SEXP fdpexpSEXP, SEXP fppexpSEXP, SEXP combnSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(NloglikFD1(par, outdata_F, outdata_proband, fgau, fdpexp, fppexp, combn));
    return rcpp_result_gen;
END_RCPP
}
// NloglikFD2
double NloglikFD2(NumericVector par, List outdata_F, NumericVector outdata_proband, Function fgau, Function fdpexp, Function fppexp, Function combn, Function ppch);
RcppExport SEXP _clusteridm_NloglikFD2(SEXP parSEXP, SEXP outdata_FSEXP, SEXP outdata_probandSEXP, SEXP fgauSEXP, SEXP fdpexpSEXP, SEXP fppexpSEXP, SEXP combnSEXP, SEXP ppchSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type par(parSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(NloglikFD2(par, outdata_F, outdata_proband, fgau, fdpexp, fppexp, combn, ppch));
    return rcpp_result_gen;
END_RCPP
}
// loglikFD1
...
static const R_CallMethodDef CallEntries[] = {
    {"_clusteridm_NloglikFD1", (DL_FUNC) &_clusteridm_NloglikFD1, 7},
